...
**Verified on live Anthropic invoices** (July 2026, gated by `stepcost sync`
against the org cost API): a 160-call run **matched to the microdollar
($0.401618 computed = $0.401618 billed)**; an earlier run measured 0.0016%.
